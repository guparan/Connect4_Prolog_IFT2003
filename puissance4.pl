...
enregistrerCoup(N, [T|X], J, [T|G], I):- N > 0, N1 is N-1, enregistrerCoup(N1, X, J, G, I).
...
enregistrerCoupJoueur(N, [T|X], J, [T|G], I):-  N > 0, N1 is N-1, enregistrerCoupJoueur(N1, X, J, G, I).

enregistrerCoupIA(1, [L|G], J, F, I):- longueur(L,N), N < 6, ajoutFin(J,L,M), F=[M|G].
enregistrerCoupIA(N, [T|X], J, [T|G], I):- N > 0, N1 is N-1, enregistrerCoupIA(N1, X, J, G, I).
...
finJeuHor(N, G, J):- maplist(nthElem(N), G, L), sublist([J,J,J,J],L),!.
finJeuHor(N, G, J):- N > 0, N1 is N-1, finJeuHor(N1, G, J).
finJeuHor(G,J):- finJeuHor(6, G, J).                             

% Condition de victoire diagonale : 4 jetons les uns après les autres en diagonale
% Il y a 12 diagonales pouvant comporter une série de 4 jetons à vérifier (6 dans chaque sens)
% code incomplet...
uneFinDiag(G,D,J,0):- sublist([J,J,J,J],D).
uneFinDiag(G,D,J,N):- N > 0, maplist(nthElem(N), G, L), nthElem(N,L,E),
                      N1 is N-1, uneFinDiag(G,[E|D],J,N1).
uneFinDiag(G,J):- uneFinDiag(G,[],J,6).
autreFinDiag(G,D,J,0):- sublist([J,J,J,J],D).
autreFinDiag(G,D,J,N):- N > 0, maplist(nthElem(N), G, L), N2 is 7-N,
                        nthElem(N2,L,E), N1 is N-1, autreFinDiag(G,[E|D],J,N1).
autreFinDiag(G,J):- autreFinDiag(G,[],J,6).

finJeuDiag(G,N,X,J):- autreFinDiag(X,J),!.
finJeuDiag(G,N,X,J):- uneFinDiag(X,J),!.
finJeuDiag(G,N,X,J):- N < 7, maplist(nthElem(N), G, L), N1 is N+1, finJeuDiag(G,N1,[L|X],J).
...
espaceRestant(N, [T|X], E, L):- N > 0, N1 is N-1, espaceRestant(N1, X, E, L).
...
enregistrerCoupArbre(N, [T|X], J, [T|G]):- N > 0, N1 is N-1, enregistrerCoupArbre(N1, X, J, G).


% Evaluation de la grille de jeu
/* Paramètres : G grille, J joueur */
evalVert([], _, P, X):- X=P, write(fini).                                                                               
evalVert([L|G],J, P, X):- sublist([J,J,J,J], L), evalVert(G, J, P, 4, X).
evalVert([L|G],J, P, X):- sublist([J,J,J], L), evalVert(G, J, P, 3, X).
evalVert([L|G],J, P, X):- sublist([J,J], L), evalVert(G, J, P, 2, X).
evalVert([L|G],J, P, X):- evalVert(G, J, P, 1, X).
evalVert(G,J, P1, P2, X):- max(P1, P2, P), evalVert(G, J, P, X).
...
tracerArbre(G, J, 0, A).
tracerArbre(G, J, P, A):- P > 0, P1 is P-1, tracerBranche(G, J, P1, A, 7).

tracerBranche(G, J, P, A, 1).                                             
tracerBranche(G, x, P, A, N):- N > 0, N1 is N-1, enregistrerCoupArbre(N, G, x, X),
                               tracerArbre(X, o, P, A), tracerBranche(G, x, P, A, N1).
tracerBranche(G, o, P, A, N):- N > 0, N1 is N-1, enregistrerCoupArbre(N, G, o, X),
                               tracerArbre(X, x, P, A), tracerBranche(G, o, P, A, N1).
                               
afficherGrille(_,0).                                                       
afficherGrille(G, N):- N > 0, N1 is N-1, maplist(nthElem(N), G, L), afficherListe(L),
                       write('\n'), afficherGrille(G, N1).
